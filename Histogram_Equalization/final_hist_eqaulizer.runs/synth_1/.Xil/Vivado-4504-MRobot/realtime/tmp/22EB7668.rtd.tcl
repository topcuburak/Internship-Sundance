...
set genomeRtd $env(RT_TMP)/22EB7668.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {histogram_equalizer__GB2}]"
...
set genomeName [subst -nocommands -novariables {histogram_equalizer__GB2}]
